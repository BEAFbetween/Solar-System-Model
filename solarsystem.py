...
class SolarSystem:
    def __init__(self,width,height):
        self.solar_system = turtle.Screen()     # graphics function   
        self.solar_system.tracer(0)
        self.solar_system.setup(width, height)  # width and height are width and height of window
        self.solar_system.screensize(width, height)
